...
// Skew correction (§7.1b) — decision cutoff for the vanishing-point fit's center angle.
// Calibrated against real-content noise floor (a known-flat real page reads ~0.2-0.3deg center on
// this estimator), not the originally hoped-for 0.2deg — seeing a number below this is
// measurement noise, not a real skew.
...
// detection rate roughly in half on a real scanned test page (14/41 at 1280px to 9/40 at 1920px).
