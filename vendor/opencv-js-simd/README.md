> **This copy's `dist/opencv.js` is a custom SIMD build, not the upstream download below.**
> See `BUILD.md` in this directory for what changed and how it was built/verified.
